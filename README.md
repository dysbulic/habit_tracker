...
This repository contains the source code for the [Habit Tracker](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=org.dhappy.habits).

Please see the [issues](https://github.org.dhappy.habits/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Habit Tracker? Ask away on the [org-dhappy-habits discussion forum](https://groups.google.com/forum/#!forum/org-dhappy-habits). 

<a href="https://play.google.com/store/apps/details?id=org.dhappy.habits" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __org.dhappy.habits__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____org.dhappy.habits__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.org.dhappy.habits.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall Habit Tracker from your device and
...
You can then import the Habit Tracker project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the Habit Tracker directory.  Click
...
Habit Tracker is a result of a template project I've developed over the years as well as
...
Habit Tracker is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.org.dhappy.habits/pulls).
